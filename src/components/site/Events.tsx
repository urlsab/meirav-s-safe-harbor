...
export function Events() {
  ...
  return (
    <section id="events" className="py-20 sm:py-28 bg-muted/40">
      <div ref={ref} className="reveal mx-auto max-w-4xl px-4 sm:px-6">
        ...
        <div className="mt-8 grid grid-cols-[2fr_3fr_3fr] grid-rows-[5fr_1fr_4fr] gap-1.5 sm:gap-2 aspect-4/3 w-full">
