...
const faqs = [
  ...
  },
  {
    ...
    a: "אפשר לפנות אלי בכל שלב של ההיריון, מרגע שאת מרגישה צורך בכך. אף פעם לא מאוחר מדי, אך ככל שנתחיל מוקדם יותר כך יהיה לנו יותר זמן לבנות קשר, להתכונן ולהתאים את הליווי לצרכים שלך.",
  },
  {
  ...
  },
  {
    ...
    a: "בהחלט ובשמחה! בן הזוג הוא חלק מרכזי ובלתי נפרד בתהליך. מפגשי ההכנה ללידה מיועדים לשניכם יחד, אני מקנה לבן הזוג כלים מעשיים איך להיות שותף פעיל ותומך בהתמודדות עם הצירים בבית, בשלב הלטנטי ולאורך הלידה כולה.",
  },
  {
  ...
  },
  {
    ...
    a: "אני זמינה לשאלות והתייעצויות לכל אורך ההיריון.",
    b: "לקראת הלידה אני זמינה עבורך 24/7. מרגע שתצרי קשר אלווה אותך טלפונית ואנחה אתכם בשלבי ההתקדמות, וכשתקבלי החלטה לצאת לבית היולדות ותודיעי לי שאת צריכה אותי אגיע אליך בהקדם האפשרי.",
  },
];
